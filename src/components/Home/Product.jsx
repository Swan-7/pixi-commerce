...
const ProductDisplay = ({ product, onAddToCart, onToggleFavorite }) => {
  const { dispatch } = useCart();
    ...
    setIsFavorite((prev) => !prev);
      console.log(`Product ${isFavorite ? 'removed from' : 'added to'} favorites`);
  };
  ...
  return (
    <div className='mt-40'>
      ...
      <h1 className='text-4xl font-semibold text-left mb-16'>Explore Our Products</h1>
          ...
          <div key={product.id} className="">
            ...
            >
              ...
              <div className="absolute flex flex-col gap-2 right-3 top-3">
                <img 
                  src={isFavorite ? filledHeart : heart } alt="" className='bg-white p-1 rounded-full cursor-pointer' 
